package com.ygzy.lib_base.dialog
...
import com.ygzy.lib_base.action.AnimAction
import com.ygzy.lib_base.aop.SingleClick
import com.ygzy.lib_base.base.AppAdapter
import com.ygzy.lib_base.base.BaseAdapter
...
class MenuDialog {
    ...
    class Builder(context: Context, positionText: (Int) -> String = {""}) : BaseDialog.Builder<Builder>(context),
        ...
        init {
            ...
            adapter = MenuAdapter(getContext(),positionText)
    ...
    class MenuAdapter (context: Context,var positionText:(Int)->String) : AppAdapter<Any>(context) {
        ...
        inner class ViewHolder : AppViewHolder(R.layout.menu_item) {
            ...
            override fun onBindView(position: Int) {
                if(positionText(position) == ""){
                    textView?.text = getItem(position).toString()
                }else {
                    textView?.text = positionText(position)
                }
